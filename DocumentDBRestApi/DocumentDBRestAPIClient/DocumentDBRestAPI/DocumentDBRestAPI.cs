...
namespace DocumentDBRestAPIClient
{
    /// <summary>
    /// </summary>
    public class DocumentDbRestApi : ServiceClient<DocumentDbRestApi>, IDocumentDbRestApi
    {
        
       

        /// <summary>
        ///     Initializes a new instance of the DocumentDBRestAPI class.
        /// </summary>
        public DocumentDbRestApi()
        {
        ...
        ///     client pipeline.
        /// </param>
        public DocumentDbRestApi(params DelegatingHandler[] handlers)
            : base(handlers)
        {
            var account = $"https://{DocumentDbAccount}documents.azure.com:443/dbs";
            BaseUri = new Uri(account);
        ...
        ///     client pipeline.
        /// </param>
        public DocumentDbRestApi(HttpClientHandler rootHandler, params DelegatingHandler[] handlers)
        ...
        ///     client pipeline.
        /// </param>
        public DocumentDbRestApi(Uri baseUri, params DelegatingHandler[] handlers)
            : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        ///     client pipeline.
        /// </param>
        public DocumentDbRestApi(ServiceClientCredentials credentials, params DelegatingHandler[] handlers)
            : this(handlers)
        {
            if (credentials == null)
            {
        ...
        ///     client pipeline.
        /// </param>
        public DocumentDbRestApi(Uri baseUri, ServiceClientCredentials credentials, params DelegatingHandler[] handlers)
            : this(handlers)
        {
            if (baseUri == null)
            {
