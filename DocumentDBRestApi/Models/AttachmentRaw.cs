...
namespace DocumentDBRestApi.Models
{
    ...
    public class AttachmentRaw
    {
        ...
        public virtual JToken SerializeJson(JToken outputObject)
        {
            ...
            if (ContentType != null)
            {
                outputObject[nameof(ContentType)] = ContentType;
            }
            if (Id != null)
            {
                outputObject["id"] = Id;
        ...
        public virtual void DeserializeJson(JToken inputObject)
        {
            ...
            var contentTypeValue = inputObject[nameof(ContentType)];
            ...
            var slugValue = inputObject[nameof(Slug)];
